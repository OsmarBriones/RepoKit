...
## 9. Reference and sandbox material
...
1. **Foundation** — fix `repo_mod_template` (`preferNameDirectory: false`), set up `RepoAPI` as the canonical repo with its own `Directory.Build.props`, verify it builds standalone.
